...
extern "C"
{
    ...
    public:
        ESP_McM_7_00(uint8_t bno = 0x81, uint8_t dactimer = 6);
    ...
    ESP_McM_7_00::ESP_McM_7_00(uint8_t bno, uint8_t dactimer)
    {
    ...
    void ESP_McM_7_00::whoami(boardconf *brd)
    {
        uint8_t temp = 0x80;
        Serial2.flush();
    ...
    void ESP_McM_7_00::setmux(uint8_t m)
    {
    ...
    void ESP_McM_7_00::clock(float freq)
    {
        uint8_t temp;
        uint32_t f;
     ...
     * Outputs: None
     */
    void ESP_McM_7_00::muxseq(float swtime, uint8_t len, uint8_t *seq, bool sync)
    {
        uint8_t temp;
        uint8_t swtime_t;
    ...
    void ESP_McM_7_00::analogWrite(float m)
    {
     ...
     * Outputs: Voltage measured by the ADC
     */
    uint8_t ESP_McM_7_00::res_dac(uint8_t res)
    {
        if (res)
        {
